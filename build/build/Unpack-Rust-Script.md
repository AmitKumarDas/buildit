...
```sh
# Each LINE is passed via STDIN                   🎖️🎖️🎖️
...
### More Closure: Count
```sh
# LINE NUMBER is passed as SECOND ARG             🎖️🎖️🎖️
...
```yaml
- RUST_SCRIPT_BASE_PATH               # 🎖️🎖️🎖️ - Context / Prefix
...
### DEBUGGING Practice
```yaml
- Run with the RUST_LOG=rust_script=trace environment variable set  # 🎖️🎖️🎖️ - Usage = =
